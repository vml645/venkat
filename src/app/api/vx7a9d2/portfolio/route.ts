...
import { normalizePortfolioStore } from '@/lib/portfolioStore'
import { readPrivatePortfolioStore, writePrivatePortfolioStore } from '@/lib/privatePortfolioStore'
...
export async function GET() {
  ...
  const store = await readPrivatePortfolioStore()
...
export async function POST(request: Request) {
  ...
  try {
    ...
    await writePrivatePortfolioStore(normalized)
